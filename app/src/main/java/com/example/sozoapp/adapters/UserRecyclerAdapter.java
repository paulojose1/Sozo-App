...
public class UserRecyclerAdapter extends RecyclerView.Adapter<UserRecyclerAdapter.ViewHolder>{
    ...
    private ArrayList<CreateUser> mUsers;
    private UserListRecyclerClickListener mClickListener;

    public UserRecyclerAdapter(ArrayList<CreateUser> users, UserListRecyclerClickListener clickListener) {
        mUsers = users;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.email.setText(mUsers.get(position).getUserEmail());
    }
